...
link = 'https://www.aviasales.ru/about/vacancies/3744792/resume'
...
try:
    ...
    cover_letter = 'Добрый день! Меня зовут Талип, и с этим письмом я откликаюсь на позицию QA Engineer в Авиасейлс. Я считаю, что обладаю нужными компетенциями и квалификацией. У меня есть опыт тестирования веб-приложений, ориентированных как на десктоп, так и на мобильные устройства. Также на своих проектах тестировал API и использовал различные инструменты, например Postman. Я очень внимателен к деталям: например, я сразу заметил опечатку в вакансии (Enginner вместо Engineer). При этом не стою на месте, а продолжаю активно развиваться как в ручном тестировании, так и в автоматизации.\n\nЯ давно слежу за вакансиями в Сале и невероятно рад предложить свою кандидатуру, чтобы вместе делать лучший traveltech в России и мире, при этом вырасти как профессионал. Я обожаю культуру компании в отношении сотрудников и клиентов. С большим удовольствием сам использую сервис для поиска дешевых авиабилетов (например, он мне помог добраться этим летом домой по самой выгодной цене). Считаю, что смогу вносить вклад в обеспечение качества продукта, для того чтобы клиенты Авиасейлс легко могли найти нужный им отель, не встречая багов.\nС уважением, Гарифулин Талип'
